...
public class CandidateCvWebSitesController {
	...
	public Result create(@RequestBody CandidateCvWebSite candidateCvWebSite) {
		return this.candidateCvWebSiteService.create(candidateCvWebSite);
	}
	...
	public DataResult<List<CandidateCvWebSite>> getByCandidateCvId(@RequestParam long candidateCvId) {
